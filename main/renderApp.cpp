...
int main(int argc, char* argv[])
{
    ...
    int nbFrames = 0;
    //Render loop
    float renderMode = 0.0;
    std::cout << "please enter input to determine post render effect:\n   0: Reset\n   1: Sobel Filter\n   2: Blur Filter" << std::endl;
    while (glfwGetKey(window, GLFW_KEY_ESCAPE) != GLFW_PRESS && glfwWindowShouldClose(window) == 0) {// Clear the screen
        ...
        postEffectShader->setRenderMode(renderMode);
        // Measure speed
